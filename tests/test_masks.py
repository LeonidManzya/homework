...
@pytest.mark.parametrize("value, expected", [
    ("094852134087746530", "Проверьте правильность введенного номера карты!"),
    ("", "Проверьте правильность введенного номера карты!"),
])
def test_get_mask_card_number_invalid(value, expected):
...
@pytest.mark.parametrize("value, expected", [
    ("084s382374f332277a4550", "Проверьте правильность введенного номера счёта!"),
    ("846382374", "Проверьте правильность введенного номера счёта!"),
    ("", "Проверьте правильность введенного номера счёта!"),
])
def test_get_mask_account_number_invalid(value, expected):
